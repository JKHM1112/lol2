export const getRunes = () => {
    const runes: { nameN: number, nameE: string, nameK: string, nameImg: string }[] = [
        ...
        },
        {
            ...
            nameE: 'Predator',
            nameK: '포식자',
            nameImg: 'perk-images/Styles/Domination/Predator/Predator.png'
        },
        {
            nameN: 8128,
            nameE: 'DarkHarvest',
        ...
        {
            nameN: 8134,
            nameE: 'IngeniousHunter',
            nameK: '영리한 사냥꾼',
            nameImg: 'perk-images/Styles/Domination/IngeniousHunter/IngeniousHunter.png'
        },
        {
            nameN: 8105,
        ...
        },
        {
            ...
            nameE: 'FuturesMarket',
            nameK: '외상',
            nameImg: 'perk-images/Styles/Inspiration/FuturesMarket/FuturesMarket.png'
        },
        {
            nameN: 8316,
            nameE: 'MinionDematerializer',
            nameK: '미니언 해체분석기',
            nameImg: 'perk-images/Styles/Inspiration/MinionDematerializer/MinionDematerializer.png'
        },
        {
            nameN: 8345,
        ...
        },
        {
            ...
            nameE: 'LethalTempo',
            nameK: '치명적 속도',
            nameImg: 'perk-images/Styles/Precision/LethalTempo/LethalTempoTemp.png'
        },
        {
            nameN: 8021,
            nameE: 'FleetFootwork',
        ...
        },
        {
            ...
            nameE: 'Overheal',
            nameK: '과다치유',
            nameImg: 'perk-images/Styles/Precision/Overheal.png'
        },
        {
            nameN: 9111,
            nameE: 'Triumph',
        ...
        {
            nameN: 9105,
            nameE: 'LegendTenacity',
            nameK: '전설: 강인함',
            nameImg: 'perk-images/Styles/Precision/LegendTenacity/LegendTenacity.png'
        },
        {
            nameN: 9103,

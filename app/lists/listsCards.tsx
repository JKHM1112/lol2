        ...
        if (totalPages <= maxButtonsToShow) {
            ...
            for (let i = 1; i <= totalPages; i++) {
                pageButtons.push(
                    <button
                        ...
                        className={`text-base  px-1 py-1 border rounded-lg  ${i === currentPage ? 'bg-blue-500 text-white' : 'bg-gray-300 hover:bg-gray-400'}`}
                    >
                        {i}
                    </button>
                );
            ...
            pageButtons.push(
                <button
                    ...
                    className={`text-base  px-1 py-1 border rounded-lg ${currentPage === 1 ? 'bg-blue-500 text-white' : 'bg-gray-300 hover:bg-gray-400'}`}
                >
                    1
                </button>
            );
            ...
            pageButtons.push(
                <button
                    ...
                    className={`text-base  px-1 py-1 border rounded-lg ${currentPage === totalPages ? 'bg-blue-500 text-white' : 'bg-gray-300 hover:bg-gray-400'}`}
                >
                    {totalPages}
                </button>
            );
            ...
            <div className="min-w-[1000px] bg-gray-100 rounded-lg shadow-md mt-4 p-4">
                ...
                <div className="flex flex-row">
                                        ...
                                        <div className={`flex flex-col ${data.gameResult === "승리" ? "bg-blue-100" : "bg-red-100"} p-2 rounded-lg`}>
                                            <div className="flex flex-row mx-2 justify-center">
                                                <div className="flex items-center gap-8">
                                                    {getChampionLoadingImg(data.chams[0], 60, 60)}
                                                    {getChampionLoadingImg(data.chams[1], 60, 60)}
                                                </div>
                                            </div>
                                            <div className="flex flex-row justify-center gap-8">
                                                <button type="button" className="text-blue-600 hover:text-blue-800 mt-2" onClick={() => handleFlipCard(data._id)}>자세히</button>
                    ...
                    <div className="gap-4 mt-2 w-3/4">
                        ...
                        <div>
                            <SelectedChampions versusCollection={versusCollection} myChampSearch={myChampSearch} enemyChampSearch={selectedChampion || enemyChampSearch} />
                        </div>
                    </div>
                </div>

...
const schema = zfd.formData({
    ...
    before6: zfd.numeric(z.number().min(0).max(10).optional()),
    after6: zfd.numeric(z.number().min(0).max(10).optional()),
    side1: zfd.numeric(z.number().min(0).max(10).optional()),
    teamFight1: zfd.numeric(z.number().min(0).max(10).optional()),

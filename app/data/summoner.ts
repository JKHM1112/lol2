...
export const summoner ={
    ...
    "data": {
        ...
        "SummonerCherryFlash": {
            ...
            "tooltip": "커서 방향으로 챔피언이 짧은 거리를 순간이동합니다.<br /><br />한 라운드 동안 다시 사용할 수 없습니다. <rules>(한 라운드는 구매 단계와 전투 단계로 구성되어 있습니다.)</rules>",
            "maxrank": 1,
            "cooldown": [
                0.25
            ],
        ...
        "SummonerCherryHold": {
            ...
            "name": "도주",
            "description": "적 챔피언으로부터 달아나는 동안 잠시 이동 속도가 대폭 증가합니다.",
            "tooltip": "<keywordMajor>사용 스킬 슬롯:</keywordMajor> 소환사 주문을 부여하는 증강이 이 슬롯을 대체합니다.<br /><br />{{ duration }}초 동안 <moveSpeed>이동 속도가 {{ basems*100 }}%</moveSpeed> 증가합니다. 뒤에 있는 적 하나당 이동 속도가 {{ bonusmsperenemybehind*100 }}% 증가합니다.",
            "maxrank": 1,
            "cooldown": [
                45
            ],
        ...
        "SummonerMana": {
            ...
            "tooltip": "최대 마나의 {{ e1 }}%를 회복하고 주변 아군의 마나를 최대 마나의 {{ e2 }}%만큼 회복시켜줍니다.",
            "maxrank": 1,
            "cooldown": [
                240
            ],
        ...
        "SummonerSmite": {
            ...
            "tooltip": "대상 몬스터 또는 공격로 미니언에게 <trueDamage>{{ smitebasedamage }}의 고정 피해</trueDamage>를 입힙니다.<br /><br />챔피언의 동료에게는 <trueDamage>{{ firstpvpdamage }}의 고정 피해</trueDamage>를 입힙니다.<br /><br /><rules>작은 몬스터에게는 사용할 수 없습니다.</rules>",
            "maxrank": 1,
            "cooldown": [
                15
            ],
        ...
        "SummonerSnowURFSnowball_Mark": {
            ...
            "tooltip": "멀리 눈덩이를 던져 첫 번째 맞은 적에게 {{ tooltipdamagetotal }}의 고정 피해를 입히고 대상에 대한 <span class=\"coloree91d7\">절대 시야</span>를 얻습니다. 적을 맞히면 이 스킬을 {{ e3 }}초 내에 재사용하여 표식이 남은 유닛에게 돌진하여 추가로 {{ tooltipdamagetotal }}의 고정 피해를 입힙니다. 대상에게 돌진하면 표식의 재사용 대기시간이 {{ e4 }}% 감소합니다.<br /><br /><span class=\"colorFFFF00\">표식의 투사체는 주문 보호막이나 투사체 약화 효과로 막을 수 없습니다.</span>",
            "maxrank": 1,
            "cooldown": [
                80
            ],
        ...
        "SummonerTeleport": {
            "id": "SummonerTeleport",
            "name": "순간이동",
            "description": "4초 동안 정신을 집중한 다음, 대상으로 지정한 아군 구조물로 순간이동합니다. 10분에 강력 순간이동으로 업그레이드됩니다. 강력 순간이동은 아군 구조물, 미니언, 혹은 와드를 대상으로 지정할 수 있습니다.",
            "tooltip": "{{ channelduration }}초 동안 정신 집중을 한 후 대상으로 지정한 아군 구조물로 순간이동합니다.<br /><br />10분에 강력 순간이동으로 업그레이드됩니다. 강력 순간이동의 재사용 대기시간은 {{ upgradedcooldown }}초이며 아군 구조물, 미니언, 와드에 사용할 수 있습니다. 사용 후 {{ msduration }}초 동안 이동 속도가 {{ msamount*100 }}% 증가합니다.",
            "maxrank": 1,
            "cooldown": [
                360
            ],
        ...
        "Summoner_UltBookPlaceholder": {
            ...
            "tooltip": "선택한 궁극기 소환사 주문으로 대체됩니다.{{ spellmodifierdescriptionappend }}",
            "maxrank": 1,
            "cooldown": [
                0
            ],
        ...
        "Summoner_UltBookSmitePlaceholder": {
            ...
            "tooltip": "궁극기 소환사 주문으로 대체됩니다.<br /><br />공격-강타를 획득합니다. 공격-강타는 이로운 효과를 주는 아군 몬스터, 에픽 몬스터, 바위 게를 공격 시 처형합니다.<br /><br /><attention>공격-강타는 재사용 대기시간이 없습니다.</attention>{{ spellmodifierdescriptionappend }}",
            "maxrank": 1,
            "cooldown": [
                0
            ],

        ...
        "slots": [
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "longDesc": "체력이 50%보다 낮은 챔피언에게 피해를 입히면 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_AdaptiveDmg'>적응형 피해</lol-uikit-tooltipped-keyword>를 추가로 입히고 해당 챔피언의 영혼을 수확해 어둠의 수확 효과의 피해량이 영구적으로 5만큼 증가합니다.<br><br>어둠의 수확 피해량: 20~80 (레벨에 비례) (+영혼당 피해량 5) (+추가 공격력의 0.1) (+주문력의 0.05)<br>재사용 대기시간: 45초 (처치 관여 시 1.5초로 초기화)"
                    },
                    {
                        "id": 9923,
                        "key": "HailOfBlades",
            ...
            },
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "longDesc": "비스킷 배달: 6분까지 2분마다 굳건한 의지의 완전한 비스킷 아이템을 얻습니다.<br><br>비스킷을 사용하면 잃은 체력과 마나의 8%를 회복합니다. 비스킷 하나를 사용하거나 판매하면 최대 마나가 영구적으로 40만큼 늘어납니다. <br><br><i>마나 없음:</i> 마나가 없는 챔피언은 마나 대신 잃은 체력의 12%를 회복합니다."
                    },{
                        "id": 8321,
                        "key": "FuturesMarket",

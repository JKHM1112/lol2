        ...
        "slots": [
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "longDesc": "체력이 50%보다 낮은 챔피언에게 피해를 입히면 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_AdaptiveDmg'>적응형 피해</lol-uikit-tooltipped-keyword>를 추가로 입히고 해당 챔피언의 영혼을 수확해 어둠의 수확 효과의 피해량이 영구적으로 9만큼 증가합니다.<br><br>어둠의 수확 피해량: 20(+영혼당 피해량 9)(+추가 공격력의 0.1)(+주문력의 0.05)<br>재사용 대기시간: 35초 (처치 관여 시 1.0초로 초기화)"
                    },
                    {
                        "id": 9923,
                        "key": "HailOfBlades",
            ...
            },
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "longDesc": "적 챔피언에게 피해를 입히면 체력을 회복합니다.<br><br>회복량: 16 ~ 40 (+추가 공격력의 0.1, +주문력의 0.05) (레벨에 비례)<br><br>재사용 대기시간: 20초"
                    },
                    {
                        "id": 8143,
                        "key": "SuddenImpact",
                ...
                "runes": [
                    {
                        ...
                        "name": "보물 사냥꾼",
                        "shortDesc": "<b>고유</b> <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 처음으로 획득하는 골드량 증가 ",
                ...
                "runes": [
                    {
                        ...
                        "name": "빙결 강화",
                        "shortDesc": "적 챔피언을 이동 불가 상태로 만들면 3줄기의 빙결 광선이 뻗어 나와 근처 적들을 둔화하고 아군에게 입히는 피해를 감소시킵니다.",
                        "longDesc": "적 챔피언을 이동 불가 상태로 만들면 대상에게서 3줄기의 빙결 광선이 자신과 근처 다른 챔피언을 향해 뻗어 나와 3초(+이동 불가 효과 지속시간의 100%) 동안 적들을 20%(+회복 및 보호막 효과 10%당 9%)(+주문력 100당 6%)(+추가 공격력 100당 7%) 둔화하고 자신을 제외한 아군에게 입히는 피해를 15% 감소시키는 빙결 영역을 생성합니다. <br><br>재사용 대기시간: 25초"
                    },
                    {
                        "id": 8360,
                    ...
                    },
                    {
                        ...
                        "longDesc": "적 챔피언과 전투 시작 후 0.25초 내에 스킬이나 기본 공격으로 해당 적 챔피언에게 피해를 입히면 10골드를 획득하고 3초 동안 <b>선제공격</b> 효과가 발동됩니다. 효과 발동 시 적 챔피언에게 <truedamage>7%</truedamage>의 추가 <truedamage>피해</truedamage>를 입힙니다. 또한 입힌 추가 피해의 <gold>50%(원거리 챔피언은 35%)</gold>에 해당하는 <gold>골드</gold>를 획득합니다.<br><br>재사용 대기시간: <scaleLevel>25~15</scaleLevel>초"
                    }
                ]
            },
            {
            ...
            },
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "name": "비스킷 배달",
                        "shortDesc": "게임 시작 후 6분까지 2분마다 비스킷 1개 획득. 비스킷 사용 또는 판매 시 체력 회복 및 최대 체력 영구 증가",
                        "longDesc": "비스킷 배달: 게임 시작 후 6분까지 2분마다 굳건한 의지의 완전한 비스킷 하나를 얻습니다.<br><br>비스킷을 사용하면 잃은 체력의 12%를 회복합니다. 비스킷 하나를 먹거나 판매하면 최대 체력이 영구히 30 증가합니다. "
                    }
                ]
            },
            {
        ...
        "slots": [
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "name": "치명적 속도",
                        "shortDesc": "적 챔피언을 기본 공격하면 공격 속도가 최대 6까지 증가. 최대 중첩 시 기본 공격을 하면 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_AdaptiveDmg'><font color='#48C4B7'>추가 적응형 피해</font></lol-uikit-tooltipped-keyword>를 입힘",
                        "longDesc": "적 챔피언을 기본 공격하면 6초 동안 공격 속도가 [근접 챔피언은 5% || 원거리 챔피언은 4%], 최대 6까지 증가합니다. 최대 중첩 시 %i:OnHit% <OnHit>기본 공격</OnHit>을 하면 [근접 챔피언은 9~30 || 원거리 챔피언은 6~24]의 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_AdaptiveDmg'><font color='#48C4B7'>추가 적응형 피해</font>를 입힙니다. 이 피해는 추가 공격 속도 1%당 1%씩 증가합니다</lol-uikit-tooltipped-keyword>."
                    },
                    {
                        "id": 8021,
                        "key": "FleetFootwork",
                        ...
                        "longDesc": "공격 또는 이동 시 충전 중첩이 쌓입니다. 중첩이 100회에 도달하면 충전 상태로 다음 공격을 할 수 있습니다.<br><br>충전 상태로 공격 시 10~130(+추가 공격력의 0.1, +주문력의 0.05)에 해당하는 체력이 회복되며 1초 동안 <speed>이동 속도가 20%</speed> 증가합니다.<br><br>원거리 챔피언의 경우 회복 효과 60%, 이동 속도 효과 75%가 적용됩니다. 미니언을 대상으로는 모든 회복 효과가 15%만 적용됩니다."
                    },
                    {
                        "id": 8010,
                        "key": "Conqueror",
            ...
            },
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "name": "승전보",
                        "shortDesc": "챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 잃은 체력의 5%를 회복하며 추가로 20골드 획득 ",
                        "longDesc": "챔피언 처치 관여 시 잃은 체력의 5%+최대 체력의 2.5%를 회복하고 20골드를 추가로 획득합니다. <br><br><hr><br><i>'가장 위험한 게임을 하는 자만이 진정 승리의 환희를 맛보았다고 말할 수 있다.' <br>—녹서스 검투사</i>"
                    },
                    {
                        "id": 8009,
                        "key": "PresenceOfMind",
                        ...
                        "name": "침착",
                        "shortDesc": "적 챔피언에게 피해를 입히면 마나 또는 기력 소량 회복. 처치 관여 시 마나 또는 기력 회복",
                        "longDesc": "적 챔피언에게 피해를 입히면 마나를 6~50(원거리 챔피언은 80%) 또는 기력을 6 회복합니다.<br><br>처치 관여 시 최대 마나 또는 기력의 15%를 돌려받습니다. <br><br>피해 회복 재사용 대기시간: 8초"
                    }
                ]
            },
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "name": "전설: 핏빛 길",
                        "shortDesc": "적 챔피언 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Takedown'>처치 관여</lol-uikit-tooltipped-keyword> 시 영구적으로 <b>생명력 흡수</b> 효과 획득. (최대치 있음) 최대치 도달 시 최대 체력 증가. 다른 전설 룬에 비해 게임 초반에 약하고 후반에 강한 룬",
                        "longDesc": "<i>전설</i> 중첩당 <scaleAD>생명력 흡수가 0.35%</scaleAD> 증가합니다. (<statGood>최대 전설 중첩 횟수: 15</statGood>) 최대 <i>전설</i> 중첩 시 <scaleHealth>최대 체력이 85</scaleHealth> 증가합니다.<br><br>챔피언 처치 관여, 에픽 몬스터 처치 관여, 대형 몬스터 처치, 미니언 처치 시마다 <i>전설</i> 중첩을 얻습니다."
                    }
                ]
            },
            {
                ...
                "runes": [
                    {
                        ...
                        "longDesc": "전투 중 4초마다 챔피언에 대한 기본 공격 시 다음 효과를 얻습니다.<li>자신 최대 체력의 3.5%에 해당하는 추가 마법 피해</li><li>자신 최대 체력의 1.2%+3만큼 체력 회복</li><li>영구적으로 체력 7 증가</li><br><rules><i>원거리 챔피언:</i> 피해량, 회복량, 체력 영구 증가량이 40% 감소합니다.</rules><br>"
                    },
                    {
                        "id": 8439,
                        "key": "Aftershock",
                ...
                "runes": [
                    {
                        ...
                        "name": "사전 준비",
                        "shortDesc": "12분 후 방어력 +8 및 마법 저항력 +8 증가와 동시에 추가 방어력 및 마법 저항력 3% 증가",
                        "longDesc": "12분 후 방어력 +8 및 마법 저항력 +8 증가와 동시에 추가 방어력 및 마법 저항력 3% 증가"
                    },
                    {
                        "id": 8444,
                        "key": "SecondWind",
                        ...
                        "longDesc": "적 챔피언에게 피해를 입으면 10초 동안 잃은 체력의 4% + 3만큼 회복합니다."
                    },
                    {
                        "id": 8473,
                        "key": "BonePlating",
                        ...
                        "name": "뼈 방패",
                        "shortDesc": "적 챔피언으로부터 피해를 입은 뒤 해당 적이 가하는 3회의 스킬 및 기본 공격으로부터 30~60만큼 피해를 덜 받습니다.<br><br><br>지속시간: 1.5초<br>재사용 대기시간: 55초",
                        "longDesc": "적 챔피언으로부터 피해를 입은 뒤 해당 적이 가하는 3회의 스킬 및 기본 공격으로부터 30~60만큼 피해를 덜 받습니다.<br><br><br>지속시간: 1.5초<br>재사용 대기시간: 55초"
                    }
                ]
            },
            {
                "runes": [
                    ...
                    },
                    {
                        ...
                        "name": "불굴의 의지",
                        "shortDesc": "군중 제어 스킬에 영향을 받을 때 방어력과 마법 저항력이 증가합니다.",
                        "longDesc": "군중 제어 스킬에 영향을 받을 때와 그 이후 2초 동안 방어력과 마법 저항력이 2~10 (레벨에 비례) 증가합니다."
                    }
                ]
            }
        ]
                ...
                "runes": [
                    {
                        ...
                        "longDesc": "적 챔피언을 기본 공격 또는 스킬로 공격하면 콩콩이를 보내 레벨에 따라 10~50(+<scaleAP>주문력의 0.05</scaleAP>)(+<scaleAD>추가 공격력의 0.1</scaleAD>)만큼 피해를 입힙니다.<br><br>아군에게 스킬로 강화 효과 또는 보호막을 적용하면 콩콩이를 보내 레벨에 따라 30~100(+<scaleAP>주문력의 0.05</scaleAP>)(+<scaleAD>추가 공격력의 0.1</scaleAD>)만큼 피해를 흡수하는 보호막을 씌웁니다.<br><br>콩콩이는 자신에게 돌아오기 전까지 다른 대상에게 보낼 수 없습니다."
                    },
                    {
                        "id": 8229,
                        "key": "ArcaneComet",
                    ...
                    },
                    {
                        ...
                        "longDesc": "4초 안에 한 챔피언에게 기본 공격 또는 <b>개별</b> 스킬 3회를 적중시키면 레벨에 따라 <speed>15~40%의 이동 속도</speed>와 75%의 둔화 저항 효과를 얻습니다. <hr>근접 챔피언의 경우 <speed>이동 속도가 25~50%</speed>까지 증가합니다.<hr>지속시간: 3초<br>재사용 대기시간: 30초~10초"
                    }
                ]
            },
            {
                "runes": [
                    {
                        ...
                        "longDesc": "마법 피해를 받아 체력이 30% 이하가 될 경우, 먼저 4초 동안 레벨에 비례해 35~110(+추가 공격력의 14%)+(주문력의 9%)의 마법 피해를 흡수하는 보호막이 생성됩니다.<br><br>재사용 대기시간: 60초"
                    },
                    {
                        "id": 8226,
                        "key": "ManaflowBand",
                    ...
                    },
                    {
                        ...
                        "longDesc": "소환사 주문 사용 후 2초 동안 <speed>이동 속도</speed>가 증가하고 유닛을 통과할 수 있습니다.<br><br>증가: 소환사 주문 재사용 대기시간에 따라 <speed>이동 속도가 12%~35%</speed> 증가합니다. (재사용 대기시간이 길수록 <speed>이동 속도</speed>가 더 많이 증가합니다.) "
                    }
                ]
            },
            {
                ...
                "runes": [
                    {
                        ...
                        "longDesc": "다음 공격 스킬 적중 시 챔피언에게 불을 붙여 1초 후 레벨에 따라 20~40의 추가 마법 피해를 줍니다.<br><br>재사용 대기시간: 10초"
                    },
                    {
                        "id": 8232,
                        "key": "Waterwalking",
                        ...
                        "longDesc": "강에 있을 때 <speed>이동 속도가 10</speed> 증가하고 레벨에 비례하여 <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>적응형</font></lol-uikit-tooltipped-keyword>으로 추가 공격력 최대 18 또는 추가 주문력 최대 30의 효과를 얻습니다.<br><br><hr><br><i>굽이치는 강물처럼 빠르고 깜짝 놀란 협곡 바위 게처럼 날렵하게 움직이리라.</i><br>"
                    },
                    {
                        "id": 8236,
                        "key": "GatheringStorm",
